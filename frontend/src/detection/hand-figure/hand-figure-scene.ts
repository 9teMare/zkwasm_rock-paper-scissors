...
function rotateFinger(joints: Object3D[], landmarks: LandmarkList, landmarkIndexes: number[]) {
    joints.forEach((joint, i) => {
        joint.rotation.y = getAngleBetweenLines(
            [landmarks[landmarkIndexes[i]], landmarks[landmarkIndexes[i + 1]]],
            [landmarks[landmarkIndexes[i + 1]], landmarks[landmarkIndexes[i + 2]]]
        );
    });
}
...
export class HandFigureScene {
    ...
    setLandmarks(landmarks: LandmarkList) {
        ...
        rotateFinger([handFigure.indexMcp, handFigure.indexPip, handFigure.indexDip], landmarks, [
            HandLandmarks.Wrist,
        ...
        rotateFinger([handFigure.middleMcp, handFigure.middlePip, handFigure.middleDip], landmarks, [
            HandLandmarks.Wrist,
        ...
        rotateFinger([handFigure.ringMcp, handFigure.ringPip, handFigure.ringDip], landmarks, [
            HandLandmarks.Wrist,
        ...
        rotateFinger([handFigure.pinkyMcp, handFigure.pinkyPip, handFigure.pinkyDip], landmarks, [
            HandLandmarks.Wrist,
